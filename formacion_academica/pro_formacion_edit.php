...
<html lang="es">
	...
	<?php
		...
		$sql = 'SELECT * FROM grado WHERE cedula_profesional = "'.$cedula.'"';
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                ...
                <small class="text-muted p-font">El registro será inmediantamente eliminado de la base de datos. Por lo cual, se recomienda precaución al solicitar esta acción.</small>
								...
								<small class="text-muted p-font">Será dirigido a la página 'Formación Académica'.</small>
              </div>
            </li>
          </ul>
        </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="username" class="p-font">Nombre de Carrea</label>
								<?php echo '<input type="text" maxlength=29 class="form-control" id="nombre" value="'.$grado['nombre'].'" required>' ?>
              ...
              <div id="fecha-inicio" class="fechas">
								...
								<div id="botones">
									<table>
										<th><button class="btn btn-lg btn-secondary btn-block" name="guardar_cambios" onclick="solicitarModificacion('<?php echo $_GET['cedula_profesional']; ?>')">Guardar</button></th>
    ...
    <footer class="blog-footer text-white">
			<input id="cedula_p" type="hidden" value="<?php echo $_GET['cedula_profesional']; ?>">
