...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>CURLUM - Tutorías</title>
		<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximun-scale=1.0, minimum-scale=1.0">
		<link rel="stylesheet" href="../css/bootstrap.min.css">
		<link rel="stylesheet" href="../css/style-fuentes.css">
		<link rel="stylesheet" href="../css/style-blog.css">
		<link rel="stylesheet" href="../css/style-pro-tutoria.css">
		<link rel="stylesheet" href="../css/font-family.css">
		<link rel="icon" href="../imagenes/CURLUM.ico">

		<script type="text/javascript">

			function editarTutoria(_idTutoria){
				setTimeout("location.href='pro_tutoria_edit.php?id="+_idTutoria+"'", 0);
			}
						...
						<div class="card flex-md-row mb-4 box-shadow h-md-250">
							<div class="card-body d-flex flex-column align-items-start">
								...
								<div class="boton-editar">
									<button class="btn btn-lg btn-secondary btn-block boton-editar" name="editar" onclick="editarTutoria('.$tutoria['id'].')">Editar</button>
								</div>
		...
		<div class="container">
			...
			<div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
				<div class="col-md-6 px-0">
					...
					<p class="lead my-3">En este módulo encontrará los registros de las tutorías que ha ofrecido. Puede agregar, modificar o incluso eliminar un registro.</p>
				</div>
			</div>

			<div>
				<div class="div-boton-crear">
					<a href="pro_tutoria_register.php"><button class="btn btn-lg btn-secondary btn-block" name="crear" type="submit">Registrar</button></a>
					<br><br><br>
				</div>
