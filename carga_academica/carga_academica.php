	    		...
	    		<header class="blog-header py-3">
		      	...
		      	<div class="row mb-2">
	            		...
	            		<div class="card-body d-flex flex-column align-items-start">
	            			...
	            			<p> 
	            				...
	            				while($reg = mysqli_fetch_array($resultado)){
										$sql = "SELECT * FROM asignatura WHERE id = reg['id_asignatura']";
										$resultado_a = mysqli_query($conexion, $sql);
										echo '<strong class="d-inline-block mb-2 text-primary">'."Nombre: ".$resultado_a['nombre']."Horas: ".$resultado_a['horas']."Fecha de Inicio: ".$resultado_a['fecha_inicio']."Fecha de Fin: ".$resultado_a['fecha_fin'].'</strong>';
									}
	            				?>
	            			</p>
	          			</div>
		        	...
		        	<div class="col-md-3">
		          		<div class="card-body d-flex flex-column align-items-start">
		  					<tr>
								<td><input class="btn btn-lg btn-primary" type="submit" value="Registrar Nueva Asignatura" name="nueva"></td>
							</tr>
		        		</div>
		        	</div>
		      	</div>
