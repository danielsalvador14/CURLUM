...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>NUEVO PROGRAMA EDUCATIVO | CURLUM</title>
	...
	if(isset($_SESSION['username']) && isset($_SESSION['administrador'])){
		...
		if(isset($_POST['guardar'])){
			...
			$sql = "INSERT INTO programae (nombre) VALUES('$nombre')";
			$resultado = mysqli_query($conexion, $sql);

			header('Location: admin_programaE.php');
	...
	<body class="bg-light">
	    <div class="container">
		    ...
		    <div class="py-5 text-center">
		        <h2 class="h-font">Ingrese los valores del nuevo Programa Educativo</h2>
		    </div>
			...
			<div class="row">
		        ...
		        <div class="col-md-8 order-md-1">
		          <h4 class="mb-3 h-font">Programa Educativo</h4>
		          <form method="post">
			            <div class="row">
						...
						<div class="col-md-12 mb-12" id="botones">
							<tr>
								...
								<a class="btn btn-lg btn-secondary" href="admin_programaE.php" >Cancelar</a>
							</tr>
						</div>
		          	</form>
	        	</div>
