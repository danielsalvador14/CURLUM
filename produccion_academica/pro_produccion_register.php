...
<html lang="es">
	<head>
  	...
  	<link rel="stylesheet" href="../css/style-pro-produccion-register.css">
        			...
        			<li class="list-group-item d-flex justify-content-between lh-condensed">
        				<div>
          				...
          				<small class="text-muted p-font">Tal como dice, guardará inmediatamente los datos en un nuevo registro, por lo cual, recomendamos la verificación del contenido ingresado.</small>
									<h6 class="my-0 h-font">¿Que pasará cuando haga clic sobre "Cancelar"?</h6>
          				<small class="text-muted p-font">Regresará a la página "Producción Académica".</small>
        				</div>
        			</li>
      			</ul>
    			</div>
        			...
        			<div class="row">
        				<div class="col-md-6 mb-3">
          				<label for="username" class="p-font">Título de Producción</label>
									<?php echo '<input type="text" maxlength=99 class="form-control" id="titulo" required>' ?>
