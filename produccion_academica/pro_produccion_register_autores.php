			...
			function guardarAutor(_numregistro){
				if (!document.getElementById("nombre").value){
					...
					if (document.getElementById("apellidom").value) {
						...
						setTimeout("location.href='pro_produccion_create_autor.php?numresgitro="+_numregistro+"&nombre="+nombre+"&apellidop="+apellidoP+"&apellidom="+apellidoM+"'", 0);
					} else {
						setTimeout("location.href='pro_produccion_create_autor.php?numresgitro="+_numregistro+"&nombre="+nombre+"&apellidop="+apellidoP+"'", 0);
					}
				}
			}
		</script>
