<?php
	if (isset($_POST) && isset($_GET['numregistro']) && isset($_GET['nombre'])
	    ...
	    $sql = 'DELETE FROM produccion_autores WHERE numRegistro = '.$_GET['numregistro'].' AND nombre_autor = "'.$_GET['nombre'].'" AND apellidoP_autor = "'.$_GET['apellidop'].'" AND apellidoM_autor IS NULL';
	  } else {
